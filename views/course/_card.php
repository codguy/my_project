...
?>
<div class="col-md-4 col-xl-3 float-left card p-0 m-2">
...
<?php }?>
  ...
  <div class="card-body">
    <h4 class="card-title col-12 ml-n2" style=" white-space:nowrap;overflow:hidden; text-overflow: ellipsis; overflow-wrap: break-word;"><?php echo $model->name?></h4>
