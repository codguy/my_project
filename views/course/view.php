	...
	<div class="row">
		<div class="col-lg-8">
			...
			<article>
				...
				<figure class="mb-4">
					<img src='<?= $model->getImageUrl() ?>' height="400px" width="900px" class="img-fluid rounded">
				</figure>
				<!-- Post content-->
			...
			<section class="mb-5">
				<div class="card bg-light">
					<div class="card-body">
						<!-- Comment form-->
						<form class="mb-4">
							<textarea class="form-control" rows="3" id="discuss" placeholder="Join the discussion and leave a comment!"></textarea>
        ...
        foreach ($comments->each() as $comment) {
            ...
            ?>
						<div class="d-flex m-3">
							<div class="flex-shrink-0">
								<img class="rounded-circle" src="<?php echo $person->getImageUrl() ?>" height="50px" width="50px" alt="..." style="overflow: hidden; object-fit: cover;" />
							</div>
							<div class="ms-3 ml-3">
								<div class="fw-bold">
									<span class="font-weight-bold"><?php echo $person->username ?></span><small class="font-weight-light ml-2"><?php echo date('M d, Y H:i A', strtotime($comment->created_on)) ?></small>
								</div>
