...
<div class="col-lg-6 col-xl-4 col-md-6 float-left">
  <div class="card user px-0" style="border-radius: 15px;" id="<?= $model->id ?>">
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-7">
          ...
          <div class="row">
            <?php
            echo Html::button($msg, ['class' => "btn $btn follow flex-grow-1 col-5 mt-1", 'id' => $model->id, 'data-id' => $model->id, 'data-key' => get_class($model)]);
            echo Html::a('<div class = "btn btn-primary"><i class="fa fa-pen text-white" aria-hidden="true"></i></div>', ['update', 'id' => $model->id], ['class' => 'col-2 mt-1 ' . $isAdmin]);
            echo Html::a('<div class = "btn btn-danger"><i class="fa fa-trash text-white" aria-hidden="true"></i></div>', ['delete', 'id' => $model->id], ['class' => 'col-2 mt-1 ' . $isAdmin]);
            echo Html::a('<div class = "btn btn-info"><i class="fas fa-copy text-white" aria-hidden="true"></i></div>', ['shadow', 'id' => $model->id], ['class' => 'col-2 mt-1 ' . $isAdmin]);
            ?>
          </div>
        </div>
      </div>
