							...
							<div class="m-sm-4">
								<ul class="list-group list-group-flush">
									...
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										...
										<div class="text-secondary col-8"><?= $form->field($model, 'link')->textInput(['type' => 'url', 'maxlength' => true, 'id' => "website"]) ?></div>
									</li>
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										<div class="mb-0 col-4">
										...
										<div class="text-secondary col-8"><?= $form->field($model, 'link')->textInput(['type' => 'url', 'maxlength' => true, 'id' => "github"]) ?></div>
									</li>
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										<div class="mb-0 col-4">
										...
										<div class="text-secondary col-8"><?= $form->field($model, 'link')->textInput(['type' => 'url', 'maxlength' => true, 'id' => "twitter"]) ?></div>
									</li>
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										<div class="mb-0 col-4">
										...
										<div class="text-secondary col-8"><?= $form->field($model, 'link')->textInput(['type' => 'url', 'maxlength' => true, 'id' => "instagram"]) ?></div>
									</li>
									<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										<div class="mb-0 col-4">
										...
										<div class="col-8"><?= $form->field($model, 'link')->textInput(['type' => 'url', 'maxlength' => true, 'id' => "facebook"]) ?></div>
									</li>
								</ul>
...
<script type="text/javascript">
	...
	$(document).on('click', '#submit', function() {
		...
		$.ajax({
			...
			dataType: 'json',
			data: arr,
			url: '<?= Url::toRoute(['user/add-social', 'id' => $id]) ?>',
			success: function(data) {
				location.window.href = '<?= Url::toRoute(['user/view', 'id' => $id]) ?>';
			}
		});
	});
</script>